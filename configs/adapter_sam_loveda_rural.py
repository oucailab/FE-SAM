...
name = "adapter_rural"
model_type = "vit_b"
root_path = "/root/autodl-tmp/outputs_loveda_rural"
...
train_datasets = [dataset_Rural, dataset_Urban]
valid_datasets = [dataset_Rural_val, dataset_Urban_val]

evaluate_coarse_mask = True
