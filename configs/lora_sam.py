...
lora_weights_paths_dict = {
    "vit_b": None,
    "vit_l": None,
    "vit_h": None,
}

name = "samed-pd-lora-no-decoder"
model_type = "vit_b"
root_path = "/root/autodl-tmp/geosam"
vit_dim = vit_dims_dict[model_type]
sam_weights_path = sam_weights_paths_dict[model_type]
lora_weights_path = lora_weights_paths_dict[model_type]
...
log_path = f"{root_path}/train_logs/sam-{model_type.replace('_', '-')}-{name.replace('_', '-')}"
tensorboard_path = f"/root/tf-logs/geosam/sam-{model_type.replace('_', '-')}-{name.replace('_', '-')}"
val_masks_save_path = f"{root_path}/predictions/sam-{model_type.replace('_', '-')}-{name.replace('_', '-')}"
...
dataset_Rural = {
    ...
    "gt_dir": "/root/autodl-tmp/data/LoveDA/Train/Rural/masks_png",
    "img_ext": ".png",
    "gt_ext": ".png",
}
...
dataset_Rural_val = {
    ...
    "gt_dir": "/root/autodl-tmp/data/LoveDA/Val/Rural/masks_png",
    "img_ext": ".png",
    "gt_ext": ".png",
}
...
dataset_Urban = {
    ...
    "gt_dir": "/root/autodl-tmp/data/LoveDA/Train/Urban/masks_png",
    "img_ext": ".png",
    "gt_ext": ".png",
}
...
dataset_Urban_val = {
    ...
    "gt_dir": "/root/autodl-tmp/data/LoveDA/Val/Urban/masks_png",
    "img_ext": ".png",
    "gt_ext": ".png",
}
...
train_datasets = [dataset_Potsdam]
valid_datasets = [dataset_Potsdam_val]
